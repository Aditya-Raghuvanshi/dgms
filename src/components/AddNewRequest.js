...
const AddNewRequest = () => {
  ...
  return (
    <div>
      <form onSubmit={(e)=> e.preventDefault()} className='absolute bg-orange-500  w-3/12 mx-auto my-5 p-12 right-0 left-0 bg-opacity-85'>
            <h1 className='text-white text-3xl my-2 font-bold '>ADD REQUEST</h1>
            <input onChange={(e)=>setNameT(e.target.value)} type="text" placeholder='Transpoter Name' className='p-2 my-4 w-full bg-gray-600 text-white'/>
            <input onChange={(e)=>setNameV(e.target.value)} type="text" placeholder='Vehicle Number' className='p-2 my-4 w-full bg-gray-600 text-white'/><br/>
            <input onChange={(e)=>setNameD(e.target.value)}  type="text" placeholder='Driver Name' className='p-2 my-4 w-full bg-gray-600 text-white'/><br/>
